...
LightManager::LightManager() : _enabledLighting(false), _maxLights(8), _camera(4, 4) {
...
void LightManager::setCamera(const Common::Matrix &camera) {
	_camera = camera;
}
